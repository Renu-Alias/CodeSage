...
export default function Login({ setCurrentPage, setIsLoggedIn, setUser }) {
  ...
  return (
    <div className="auth-page-container">
      ...
      <div className="auth-card">
        <h2>Welcome back</h2>
        <p className="auth-subtitle">Log in to continue improving your code</p>
        ...
        <button type="button" className="social-auth-btn" onClick={handleGoogleLogin}>
