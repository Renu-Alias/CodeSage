...
function App() {
  ...
  const protectedRoutes = ['analyze', 'dashboard', 'learn', 'payment', 'account-settings', 'classroom'];
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      default:
        return <Home setCurrentPage={setCurrentPage} setSampleCode={setSampleCode} isLoggedIn={isLoggedIn} />;
    }
  };
